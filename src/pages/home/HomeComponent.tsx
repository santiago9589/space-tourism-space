        ...
        <ContainerContext>
            <ContainerChild>
                <section className='w-full h-full flex items-center flex-col justify-center'>
                    ...
                    <h1 className='text-center uppercase font-bellefair md:text-[150px] text-[80px] w-full text-whiteReq'>Space</h1>
            ...
            <ContainerChild>
                <section className='w-full h-full flex items-center flex-col xl:justify-center justify-start'>
                    <section className='w-[150px] h-[150px] md:w-[242px] md:h-[242px]  xl:w-[274px] xl:h-[274px] rounded-full bg-whiteReq text-blackReq flex justify-center items-center'>
                        <h1 className='font-bellefair md:text-[32px] text-[20px] tracking-[2px]'>EXPLORER</h1>
                    </section>
                </section>
            </ContainerChild>
        </ContainerContext>
